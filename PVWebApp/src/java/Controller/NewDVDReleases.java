 ...
 * @throws MalformedURLException for incorrect Exception
 * @throws IOException for unable to read data
 */
  ...
  */
    ...
    private void makeReleases() {
        movie.getMovies().stream().map((curGson) -> new Movie(
                curGson.getTitle(), curGson.getId(), curGson.getRuntime(),
                curGson.getYear(), curGson.getRuntime(),
